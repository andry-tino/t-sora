...
| `shadowCameraNear` | Number | The ste |
| `shadowCameraFar` | Number | The ste |
| `shadowCameraFov` | Number | The ste |
| `shadowCameraLeft` | Number | The ste |
| `shadowCameraRight` | Number | The ste |
| `shadowCameraTop` | Number | The ste |
| `shadowCameraBottom` | Number | The ste |
| `shadowBias` | Number | The ste |
| `shadowDarkness` | Number | The ste |
| `shadowMapWidth` | Number | The ste |
| `shadowMapHeight` | Number | The ste |
